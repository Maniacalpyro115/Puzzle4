window.ENEMY_DATA = {
  ...
  mercyFailure: "* It watches your mercy like prey watches thunder.",
  mercySuccess: "* You spare the BUCKY'S PANTHER.",
  mercyWinMessage: "The panther disappears into the dark.",

  enemyDialog: [
    "* The brush goes silent...",
    "* Claws cut through the dark."
  ],
  ...
  phase2: {
    ...
    mercyFailure: "* Yes, the panther is '''''real'''''",
    mercySuccess: "* You spare the panther's new form.",
    mercyWinMessage: "The panther leaves the stage.",
    enemyDialog: [
      "* The moon disappears...",
      "* The dark starts hunting."
    ],
