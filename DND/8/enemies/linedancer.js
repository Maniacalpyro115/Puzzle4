...
phase2: {
    ...
    mercyLowHpThreshold: 25,
    mercyLowHpMessage: "* LINEDANCER EX will not leave before the encore.",
    mercyHighHpMessage: "* The encore is just getting started.",
    enemyAttackMessage: "* The floor turns into a stomping blur.",
    enemyWarmupMessage: "* The encore winds up...",
